...
\begin{figure}[H]
    \includegraphics[width=200pt]{slike/def_orig.bmp}
    \centering
...
\begin{figure}[H]
    \includegraphics[width=200pt]{slike/def_kompr.bmp}
    \centering
...
\begin{figure}[H]
    \includegraphics[width=200pt]{slike/originalni_spektrogram.bmp}
    \centering
...
\begin{figure}[H]
    \includegraphics[width=200pt]{slike/spektrogram_nakon_kompresije.bmp}
    \centering
...
\begin{figure}[H]
    \includegraphics[width=200pt]{slike/prenizak_prag.bmp}
    \centering
