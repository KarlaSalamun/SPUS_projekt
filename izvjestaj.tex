...
\renewcommand{\abstractname}{Sažetak}    % clear the title
\renewcommand{\refname}{Literatura}

\begin{abstract}
Ovom temom pokriveni su neki od efekata koji se koriste u obradi zvuka gitare kao što su distorzija, kompresija,
\textit{flanger}, odjek i tremolo. Navedeni efekti su opisani i zatim dodani na osnovni zvuk gitare. Nakon dodavanja
efekta analizirani su spektrogrami originalnih i obrađenih signala.
\end{abstract}
...
pojaseve, dok druge ne mijenjaju. Za analizu signala korišten je spektrogram koji prikazuje snagu pojedinih
frekvencijskih komponenata u vremenu.
...
\begin{figure}[H]
    \includegraphics[width=200pt]{slike/originalni-2500.jpg}
    \centering
...
\begin{figure}[H]
    \includegraphics[width=200pt]{slike/nakon_kompresije-2500.jpg}
    \centering
...
Modulacijski efekti mijenjaju zvuk gitare modulacijom nekih svojstava signala kao što su faza, harmonici,
frekvencija, amplituda itd. Modulacijom vremena zvuka pomoću kašnjenja sa osnovnim signalom dobije se \textit{flanger}.
Tremolo efekt se postiže modulacijom amplitude signala. Vremenski efekti se temelje na manipulaciji vremena.
Odjek je efekt koji se temelji na odjeku zvučnog signala dok je kašnjenje ustvari samo odjek u izraženijem obliku.
Ovaj efekt se postiže tako da se izvorni signal ponovi nakon određenog vremenskog perioda. Kompresija je dinamički
efekt koji smanjuje dinamički raspon odnosno smanjuje najglasniji i najtiši dio zvučnog signala. Nakon primjene
kompresije tiši dijelovi signala su pojačani, a glasniji su prigušeni. Distorzija mijenja izvorni zvuk na način
da izobliči valni oblik signala.
